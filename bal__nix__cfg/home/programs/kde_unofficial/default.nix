...

{
  programs.plasma = {
    ...
    configFile = {
      ...
      "khotkeysrc"."Desktop Entry"."DefaultProfilex5b$dx5d" = "";
      ...
      "khotkeysrc"."KDE"."ColorSchemex5b$dx5d" = "";
      ...
      "khotkeysrc"."KDE Action Restrictions"."action/start_new_sessionx5b$dx5d" = "";
      "khotkeysrc"."KDE Action Restrictions"."action/switch_user" = "";
      "khotkeysrc"."KDE Action Restrictions"."action/switch_user\x5b$d\x5d" = "";
      "khotkeysrc"."KDE Action Restrictions"."action/switch_userx5b$dx5d" = "";
