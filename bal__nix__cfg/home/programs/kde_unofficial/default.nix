...

{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "org.gnome.Prompt.desktop"."_launch" = [ ];
      "org.gnome.Prompt.desktop"."new-tab" = [ ];
      "org.gnome.Prompt.desktop"."new-window" = [ ];
      "org.gnome.Prompt.desktop"."preferences" = [ ];
    ...
    configFile = {
      ...
      "dolphinrc"."DetailsMode"."SidePadding".value = 19;
      ...
      "kactivitymanagerdrc"."Plugins"."org.kde.ActivityManager.VirtualDesktopSwitchEnabled".value = true;
      "kactivitymanagerdrc"."activities"."09db50d0-706e-423f-a4bb-3edda1acddf4".value = "Default";
      "kactivitymanagerdrc"."activities"."13c48c44-34be-46b5-b624-439c20b7a669".value = "Coding";
      "kactivitymanagerdrc"."activities"."69e82d6b-6d9c-4958-a148-9a004ec4ea01".value = "Office";
      "kactivitymanagerdrc"."activities-icons"."13c48c44-34be-46b5-b624-439c20b7a669".value = "com.visualstudio.code.oss";
      "kactivitymanagerdrc"."activities-icons"."69e82d6b-6d9c-4958-a148-9a004ec4ea01".value = "org.libreoffice.LibreOffice.main";
      "kactivitymanagerdrc"."main"."currentActivity".value = "09db50d0-706e-423f-a4bb-3edda1acddf4";
      "kactivitymanagerdrc"."main"."runningActivities".value = "09db50d0-706e-423f-a4bb-3edda1acddf4,13c48c44-34be-46b5-b624-439c20b7a669";
      "kactivitymanagerdrc"."main"."stoppedActivities".value = "69e82d6b-6d9c-4958-a148-9a004ec4ea01";
      "kcminputrc"."Libinput/1267/12587/ELAN050B:00 04F3:312B Touchpad"."DisableWhileTyping".value = false;
      "kcminputrc"."Libinput/1267/12587/ELAN050B:00 04F3:312B Touchpad"."NaturalScroll".value = true;
      "kcminputrc"."Libinput/1267/12587/ELAN050B:00 04F3:312B Touchpad"."TapToClick".value = true;
      ...
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size".value = "910,512";
      "kdeglobals"."General"."AccentColor".value = "148,71,45";
      "kdeglobals"."General"."AllowKDEAppsToRememberWindowPositions".value = true;
      "kdeglobals"."General"."BrowserApplication".value = "org.mozilla.firefox.desktop";
      "kdeglobals"."General"."LastUsedCustomAccentColor".value = "148,71,45";
      "kdeglobals"."General"."TerminalApplication".value = "konsole";
      "kdeglobals"."General"."TerminalService".value = "/home/d/.local/share/applications/konsole.desktop";
      "kdeglobals"."General"."XftHintStyle".value = "hintslight";
      "kdeglobals"."General"."XftSubPixel".value = "none";
      "kdeglobals"."General"."fixed".value = "JetBrainsMono Nerd Font,11,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."font".value = "SF Pro Text,11,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."menuFont".value = "SF Pro Display,11,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."smallestReadableFont".value = "SF Pro Text,9,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."toolBarFont".value = "SF Pro Display,11,-1,5,50,0,0,0,0,0";
      ...
      "kdeglobals"."KScreen"."ScaleFactor".value = 1;
      "kdeglobals"."KScreen"."ScreenScaleFactors".value = "eDP=1;HDMI-A-0=1;";
      "kdeglobals"."PreviewSettings"."MaximumRemoteSize".value = 0;
      "kdeglobals"."Toolbar style"."ToolButtonStyle".value = "TextBesideIcon";
      "kdeglobals"."WM"."activeBackground".value = "49,54,59";
      "kdeglobals"."WM"."activeBlend".value = "252,252,252";
      "kdeglobals"."WM"."activeFont".value = "SF Pro Display,11,-1,5,50,0,0,0,0,0";
      ...
      "kglobalshortcutsrc"."org.gnome.Prompt.desktop"."_k_friendly_name".value = "Prompt";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid".value = "{381382be-3468-46a9-a5fb-cf3efef5755f}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid".value = "{1e0d66d8-e245-4b90-8774-2a99fde2228b}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid".value = "{4ae5b499-e870-4625-9911-1109e4ed42fd}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid".value = "{abca913a-e61d-4017-b8c7-c9c97e1ac92d}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid".value = "{5c7da5c0-ae92-4921-bab0-78d0b5ae1a15}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid".value = "{e4c4ddbb-4250-478f-b755-ea495e2866f9}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid".value = "{6f361195-c51b-4531-85bc-bdc6d247d27b}";
      ...
      "khotkeysrc"."Desktop Entry"."DefaultProfile[$d]".value = "";
      ...
      "khotkeysrc"."KDE"."ColorScheme[$d]".value = "";
      "khotkeysrc"."KDE"."LookAndFeelPackage[$d]".value = "";
      "khotkeysrc"."KDE"."SingleClick[$d]".value = "";
      "khotkeysrc"."KDE"."widgetStyle[$d]".value = "";
      "khotkeysrc"."KDE Action Restrictions"."action/start_new_session[$d]".value = "";
      "khotkeysrc"."KDE Action Restrictions"."action/switch_user[$d]".value = "";
      ...
      "khotkeysrc"."Shortcuts"."AboutApp[$d]".value = "";
      "khotkeysrc"."Shortcuts"."AboutKDE[$d]".value = "";
      "khotkeysrc"."Shortcuts"."Clear[$d]".value = "";
      "khotkeysrc"."Shortcuts"."ConfigureNotifications[$d]".value = "";
      "khotkeysrc"."Shortcuts"."ConfigureToolbars[$d]".value = "";
      "khotkeysrc"."Shortcuts"."Donate[$d]".value = "";
      "khotkeysrc"."Shortcuts"."EditBookmarks[$d]".value = "";
      "khotkeysrc"."Shortcuts"."FitToHeight[$d]".value = "";
      "khotkeysrc"."Shortcuts"."FitToPage[$d]".value = "";
      "khotkeysrc"."Shortcuts"."FitToWidth[$d]".value = "";
      "khotkeysrc"."Shortcuts"."GotoPage[$d]".value = "";
      "khotkeysrc"."Shortcuts"."Goto[$d]".value = "";
      "khotkeysrc"."Shortcuts"."Mail[$d]".value = "";
      "khotkeysrc"."Shortcuts"."OpenRecent[$d]".value = "";
      "khotkeysrc"."Shortcuts"."PrintPreview[$d]".value = "";
      "khotkeysrc"."Shortcuts"."ReportBug[$d]".value = "";
      "khotkeysrc"."Shortcuts"."Revert[$d]".value = "";
      "khotkeysrc"."Shortcuts"."SaveOptions[$d]".value = "";
      "khotkeysrc"."Shortcuts"."ShowStatusbar[$d]".value = "";
      "khotkeysrc"."Shortcuts"."ShowToolbar[$d]".value = "";
      "khotkeysrc"."Shortcuts"."Spelling[$d]".value = "";
      "khotkeysrc"."Shortcuts"."SwitchApplicationLanguage[$d]".value = "";
      "khotkeysrc"."Shortcuts"."TipofDay[$d]".value = "";
      "khotkeysrc"."Shortcuts"."Zoom[$d]".value = "";
      ...
      "kscreenlockerrc"."Greeter/Wallpaper/org/kde/image/General"."Image".value = "/usr/share/wallpapers/Flow/";
      ...
      "ksmserverrc"."SubSession: 69e82d6b-6d9c-4958-a148-9a004ec4ea01"."count".value = 0;
      "ksmserverrc"."SubSession: dde7123e-11fc-4563-99df-a09fa3f6a17f"."count".value = 0;
      ...
      "kwinrc"."Desktops"."BorderActivate".value = 3;
      ...
      "kwinrc"."Effect-overview"."BorderActivate".value = 3;
      ...
      "kwinrc"."ScreenEdges"."RemainActiveOnFullscreen".value = true;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."active".value = "-1";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."activities1".value = "09db50d0-706e-423f-a4bb-3edda1acddf4";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."activities2".value = "09db50d0-706e-423f-a4bb-3edda1acddf4";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."activities3".value = "09db50d0-706e-423f-a4bb-3edda1acddf4";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."activities4".value = "09db50d0-706e-423f-a4bb-3edda1acddf4";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."activities5".value = "4ff0a233-5955-4af8-8a28-110457742fca";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."count".value = 0;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."desktop1".value = 3;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."desktop2".value = 1;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."desktop3".value = 1;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."desktop4".value = 1;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."desktop5".value = 4;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."fsrestore1".value = "0,0,0,0";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."fsrestore2".value = "0,0,0,0";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."fsrestore3".value = "0,0,0,0";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."fsrestore4".value = "0,0,0,0";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."fsrestore5".value = "0,0,0,0";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."fullscreen1".value = 0;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."fullscreen2".value = 0;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."fullscreen3".value = 0;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."fullscreen4".value = 0;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."fullscreen5".value = 0;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."geometry1".value = "0,37,1366,687";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."geometry2".value = "0,0,1366,724";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."geometry3".value = "183,37,1000,687";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."geometry4".value = "106,72,1122,652";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."geometry5".value = "0,0,1366,724";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."iconified1".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."iconified2".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."iconified3".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."iconified4".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."iconified5".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."keepBelow1".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."keepBelow2".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."keepBelow3".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."keepBelow4".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."keepBelow5".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."maximize1".value = 3;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."maximize2".value = 3;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."maximize3".value = 1;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."maximize4".value = 0;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."maximize5".value = 3;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."opacity1".value = 1;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."opacity2".value = 1;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."opacity3".value = 1;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."opacity4".value = 1;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."opacity5".value = 1;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."resourceClass1".value = "dolphin";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."resourceClass2".value = "firefox";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."resourceClass3".value = "plasma-systemmonitor";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."resourceClass4".value = "systemsettings";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."resourceClass5".value = "firefox";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."resourceName1".value = "dolphin";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."resourceName2".value = "navigator";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."resourceName3".value = "plasma-systemmonitor";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."resourceName4".value = "systemsettings";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."resourceName5".value = "navigator";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."restore1".value = "228,121,910,482";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."restore2".value = "393,138,579,448";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."restore3".value = "183,0,1000,0";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."restore4".value = "106,35,1122,689";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."restore5".value = "393,138,579,448";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."sessionId1".value = "10f5139109c9000168703577900000013880008";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."sessionId2".value = "10f5139109c9000168703611500000013880009";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."sessionId3".value = "10f5139109c9000168703747800000013880011";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."sessionId4".value = "10f5139109c9000168703755400000013880012";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."sessionId5".value = "10f5139109c9000168703611500000013880009";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."shaded1".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."shaded2".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."shaded3".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."shaded4".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."shaded5".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."shortcut1".value = "";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."shortcut2".value = "";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."shortcut3".value = "";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."shortcut4".value = "";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."shortcut5".value = "";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."skipPager1".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."skipPager2".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."skipPager3".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."skipPager4".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."skipPager5".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."skipSwitcher1".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."skipSwitcher2".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."skipSwitcher3".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."skipSwitcher4".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."skipSwitcher5".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."skipTaskbar1".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."skipTaskbar2".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."skipTaskbar3".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."skipTaskbar4".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."skipTaskbar5".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."stackingOrder1".value = 6;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."stackingOrder2".value = 1;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."stackingOrder3".value = 2;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."stackingOrder4".value = 4;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."stackingOrder5".value = 9;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."staysOnTop1".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."staysOnTop2".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."staysOnTop3".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."staysOnTop4".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."staysOnTop5".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."sticky1".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."sticky2".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."sticky3".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."sticky4".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."sticky5".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."userNoBorder1".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."userNoBorder2".value = true;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."userNoBorder3".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."userNoBorder4".value = false;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."userNoBorder5".value = true;
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."windowRole1".value = "Dolphin#1";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."windowRole2".value = "browser";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."windowRole3".value = "";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."windowRole4".value = "MainWindow#1";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."windowRole5".value = "browser";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."windowType1".value = "Normal";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."windowType2".value = "Normal";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."windowType3".value = "Normal";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."windowType4".value = "Normal";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."windowType5".value = "Normal";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."wmCommand1".value = "";
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."wmCommand2".value = "firefoxs";
      ...
      "kwinrc"."org/kde/kdecoration2"."ButtonsOnRight".value = "HAX";
      "kwinrulesrc"."0db0554c-fa78-4ad3-ba9e-c94d31bf2b23"."Description".value = "Application settings for code - insiders";
      "kwinrulesrc"."0db0554c-fa78-4ad3-ba9e-c94d31bf2b23"."activity".value = "4ff0a233-5955-4af8-8a28-110457742fca";
      "kwinrulesrc"."0db0554c-fa78-4ad3-ba9e-c94d31bf2b23"."activityrule".value = 2;
      "kwinrulesrc"."0db0554c-fa78-4ad3-ba9e-c94d31bf2b23"."clientmachine".value = "my-archie.Bal-Aspire-3";
      "kwinrulesrc"."0db0554c-fa78-4ad3-ba9e-c94d31bf2b23"."wmclass".value = "code - insiders";
      "kwinrulesrc"."0db0554c-fa78-4ad3-ba9e-c94d31bf2b23"."wmclassmatch".value = 1;
      "kwinrulesrc"."1"."Description".value = "Window settings for vpetsettings";
      "kwinrulesrc"."1"."clientmachine".value = "localhost";
      "kwinrulesrc"."1"."desktops".value = "\0";
      "kwinrulesrc"."1"."desktopsrule".value = 3;
      "kwinrulesrc"."1"."skiptaskbar".value = true;
      "kwinrulesrc"."1"."skiptaskbarrule".value = 2;
      "kwinrulesrc"."1"."title".value = "DVPet";
      "kwinrulesrc"."1"."titlematch".value = 1;
      "kwinrulesrc"."1"."types".value = 1;
      "kwinrulesrc"."1"."wmclass".value = "vpetsettings";
      "kwinrulesrc"."1"."wmclassmatch".value = 1;
      "kwinrulesrc"."2"."Description".value = "Window settings for calibre";
      "kwinrulesrc"."2"."clientmachine".value = "localhost";
      "kwinrulesrc"."2"."ignoregeometry".value = true;
      "kwinrulesrc"."2"."ignoregeometryrule".value = 2;
      "kwinrulesrc"."2"."maxsize".value = "806,560";
      "kwinrulesrc"."2"."maxsizerule".value = 2;
      "kwinrulesrc"."2"."minsize".value = "806,560";
      "kwinrulesrc"."2"."minsizerule".value = 2;
      "kwinrulesrc"."2"."position".value = "286,88";
      "kwinrulesrc"."2"."positionrule".value = 3;
      "kwinrulesrc"."2"."title".value = "Python Crash Course, 3rd Edition [EPUB] — E-book viewer";
      "kwinrulesrc"."2"."types".value = 1;
      "kwinrulesrc"."2"."wmclass".value = "calibre-ebook-viewer";
      "kwinrulesrc"."2"."wmclasscomplete".value = true;
      "kwinrulesrc"."2"."wmclassmatch".value = 1;
      "kwinrulesrc"."3"."Description".value = "Window settings for ts4_x64.exe";
      "kwinrulesrc"."3"."clientmachine".value = "localhost";
      "kwinrulesrc"."3"."desktops".value = "\0";
      "kwinrulesrc"."3"."ignoregeometry".value = true;
      "kwinrulesrc"."3"."maxsize".value = "806,560";
      "kwinrulesrc"."3"."minsize".value = "806,560";
      "kwinrulesrc"."3"."noborder".value = true;
      "kwinrulesrc"."3"."noborderrule".value = 2;
      "kwinrulesrc"."3"."position".value = "286,88";
      "kwinrulesrc"."3"."skiptaskbar".value = true;
      "kwinrulesrc"."3"."title".value = "The Sims™ 4";
      "kwinrulesrc"."3"."titlematch".value = 1;
      "kwinrulesrc"."3"."types".value = 1;
      "kwinrulesrc"."3"."wmclass".value = "ts4_x64.exe";
      "kwinrulesrc"."3"."wmclassmatch".value = 1;
      "kwinrulesrc"."304039ee-986b-4888-8e7f-b36d2abc31c1"."Description".value = "Window settings for ts4_x64.exe";
      "kwinrulesrc"."304039ee-986b-4888-8e7f-b36d2abc31c1"."clientmachine".value = "localhost";
      "kwinrulesrc"."304039ee-986b-4888-8e7f-b36d2abc31c1"."maximizehoriz".value = true;
      "kwinrulesrc"."304039ee-986b-4888-8e7f-b36d2abc31c1"."maximizehorizrule".value = 2;
      "kwinrulesrc"."304039ee-986b-4888-8e7f-b36d2abc31c1"."maximizevert".value = true;
      "kwinrulesrc"."304039ee-986b-4888-8e7f-b36d2abc31c1"."maximizevertrule".value = 2;
      "kwinrulesrc"."304039ee-986b-4888-8e7f-b36d2abc31c1"."noborder".value = true;
      "kwinrulesrc"."304039ee-986b-4888-8e7f-b36d2abc31c1"."noborderrule".value = 2;
      "kwinrulesrc"."304039ee-986b-4888-8e7f-b36d2abc31c1"."title".value = "The Sims™ 4";
      "kwinrulesrc"."304039ee-986b-4888-8e7f-b36d2abc31c1"."titlematch".value = 1;
      "kwinrulesrc"."304039ee-986b-4888-8e7f-b36d2abc31c1"."types".value = 1;
      "kwinrulesrc"."304039ee-986b-4888-8e7f-b36d2abc31c1"."wmclass".value = "ts4_x64.exe";
      "kwinrulesrc"."304039ee-986b-4888-8e7f-b36d2abc31c1"."wmclassmatch".value = 1;
      "kwinrulesrc"."4"."Description".value = "Window settings for calibre";
      "kwinrulesrc"."4"."clientmachine".value = "localhost";
      "kwinrulesrc"."4"."ignoregeometry".value = true;
      "kwinrulesrc"."4"."ignoregeometryrule".value = 2;
      "kwinrulesrc"."4"."maxsize".value = "806,560";
      "kwinrulesrc"."4"."maxsizerule".value = 2;
      "kwinrulesrc"."4"."minsize".value = "806,560";
      "kwinrulesrc"."4"."minsizerule".value = 2;
      "kwinrulesrc"."4"."noborder".value = true;
      "kwinrulesrc"."4"."position".value = "286,88";
      "kwinrulesrc"."4"."positionrule".value = 3;
      "kwinrulesrc"."4"."title".value = "Python Crash Course, 3rd Edition [EPUB] — E-book viewer";
      "kwinrulesrc"."4"."types".value = 1;
      "kwinrulesrc"."4"."wmclass".value = "calibre-ebook-viewer calibre";
      "kwinrulesrc"."4"."wmclasscomplete".value = true;
      "kwinrulesrc"."4"."wmclassmatch".value = 1;
      "kwinrulesrc"."461ca588-041c-4356-9882-2f7b42b2a4af"."Description".value = "Window settings for ts4_x64.exe";
      "kwinrulesrc"."461ca588-041c-4356-9882-2f7b42b2a4af"."clientmachine".value = "localhost";
      "kwinrulesrc"."461ca588-041c-4356-9882-2f7b42b2a4af"."noborder".value = true;
      "kwinrulesrc"."461ca588-041c-4356-9882-2f7b42b2a4af"."noborderrule".value = 2;
      "kwinrulesrc"."461ca588-041c-4356-9882-2f7b42b2a4af"."title".value = "The Sims™ 4";
      "kwinrulesrc"."461ca588-041c-4356-9882-2f7b42b2a4af"."titlematch".value = 1;
      "kwinrulesrc"."461ca588-041c-4356-9882-2f7b42b2a4af"."types".value = 1;
      "kwinrulesrc"."461ca588-041c-4356-9882-2f7b42b2a4af"."wmclass".value = "ts4_x64.exe";
      "kwinrulesrc"."461ca588-041c-4356-9882-2f7b42b2a4af"."wmclassmatch".value = 1;
      "kwinrulesrc"."5"."Description".value = "Window settings for ts4_x64.exe";
      "kwinrulesrc"."5"."clientmachine".value = "localhost";
      "kwinrulesrc"."5"."noborder".value = true;
      "kwinrulesrc"."5"."noborderrule".value = 2;
      "kwinrulesrc"."5"."title".value = "The Sims™ 4";
      "kwinrulesrc"."5"."titlematch".value = 1;
      "kwinrulesrc"."5"."types".value = 1;
      "kwinrulesrc"."5"."wmclass".value = "ts4_x64.exe";
      "kwinrulesrc"."5"."wmclassmatch".value = 1;
      "kwinrulesrc"."52d712c6-8164-48a2-b2b9-cff0bb76b6a5"."Description".value = "Window settings for org.kde.dolphin";
      "kwinrulesrc"."52d712c6-8164-48a2-b2b9-cff0bb76b6a5"."desktops".value = "\0";
      "kwinrulesrc"."52d712c6-8164-48a2-b2b9-cff0bb76b6a5"."desktopsrule".value = 2;
      "kwinrulesrc"."52d712c6-8164-48a2-b2b9-cff0bb76b6a5"."title".value = "silk — Dolphin";
      "kwinrulesrc"."52d712c6-8164-48a2-b2b9-cff0bb76b6a5"."types".value = 1;
      "kwinrulesrc"."52d712c6-8164-48a2-b2b9-cff0bb76b6a5"."wmclass".value = "dolphin org.kde.dolphin";
      "kwinrulesrc"."52d712c6-8164-48a2-b2b9-cff0bb76b6a5"."wmclasscomplete".value = true;
      "kwinrulesrc"."52d712c6-8164-48a2-b2b9-cff0bb76b6a5"."wmclassmatch".value = 1;
      "kwinrulesrc"."79255805-373c-4d48-8b56-e69686fff7fd"."Description".value = "Window settings for calibre";
      "kwinrulesrc"."79255805-373c-4d48-8b56-e69686fff7fd"."clientmachine".value = "localhost";
      "kwinrulesrc"."79255805-373c-4d48-8b56-e69686fff7fd"."ignoregeometry".value = true;
      "kwinrulesrc"."79255805-373c-4d48-8b56-e69686fff7fd"."ignoregeometryrule".value = 2;
      "kwinrulesrc"."79255805-373c-4d48-8b56-e69686fff7fd"."maxsize".value = "806,560";
      "kwinrulesrc"."79255805-373c-4d48-8b56-e69686fff7fd"."maxsizerule".value = 2;
      "kwinrulesrc"."79255805-373c-4d48-8b56-e69686fff7fd"."minsize".value = "806,560";
      "kwinrulesrc"."79255805-373c-4d48-8b56-e69686fff7fd"."minsizerule".value = 2;
      "kwinrulesrc"."79255805-373c-4d48-8b56-e69686fff7fd"."position".value = "286,88";
      "kwinrulesrc"."79255805-373c-4d48-8b56-e69686fff7fd"."positionrule".value = 3;
      "kwinrulesrc"."79255805-373c-4d48-8b56-e69686fff7fd"."title".value = "Python Crash Course, 3rd Edition [EPUB] — E-book viewer";
      "kwinrulesrc"."79255805-373c-4d48-8b56-e69686fff7fd"."types".value = 1;
      "kwinrulesrc"."79255805-373c-4d48-8b56-e69686fff7fd"."wmclass".value = "calibre-ebook-viewer calibre";
      "kwinrulesrc"."79255805-373c-4d48-8b56-e69686fff7fd"."wmclasscomplete".value = true;
      "kwinrulesrc"."79255805-373c-4d48-8b56-e69686fff7fd"."wmclassmatch".value = 1;
      "kwinrulesrc"."7f22235b-88f8-4376-bc9f-972967cb9338"."Description".value = "Application settings for ts4_x64.exe";
      "kwinrulesrc"."7f22235b-88f8-4376-bc9f-972967cb9338"."activity".value = "375f483a-12e8-4892-b192-f8526575f324";
      "kwinrulesrc"."7f22235b-88f8-4376-bc9f-972967cb9338"."activityrule".value = 2;
      "kwinrulesrc"."7f22235b-88f8-4376-bc9f-972967cb9338"."clientmachine".value = "localhost";
      "kwinrulesrc"."7f22235b-88f8-4376-bc9f-972967cb9338"."wmclass".value = "ts4_x64.exe";
      "kwinrulesrc"."7f22235b-88f8-4376-bc9f-972967cb9338"."wmclassmatch".value = 1;
      "kwinrulesrc"."9cf5120d-2f08-4636-b512-4e4a28ea997b"."Description".value = "Window settings for org.kde.konsole";
      "kwinrulesrc"."9cf5120d-2f08-4636-b512-4e4a28ea997b"."desktops".value = "\0";
      "kwinrulesrc"."9cf5120d-2f08-4636-b512-4e4a28ea997b"."desktopsrule".value = 2;
      "kwinrulesrc"."9cf5120d-2f08-4636-b512-4e4a28ea997b"."title".value = "d : zsh — Konsole";
      "kwinrulesrc"."9cf5120d-2f08-4636-b512-4e4a28ea997b"."types".value = 1;
      "kwinrulesrc"."9cf5120d-2f08-4636-b512-4e4a28ea997b"."wmclass".value = "konsole org.kde.konsole";
      "kwinrulesrc"."9cf5120d-2f08-4636-b512-4e4a28ea997b"."wmclasscomplete".value = true;
      "kwinrulesrc"."9cf5120d-2f08-4636-b512-4e4a28ea997b"."wmclassmatch".value = 1;
      "kwinrulesrc"."General"."count".value = 3;
      "kwinrulesrc"."General"."rules".value = "1,2,3";
      "kwinrulesrc"."eac1aa75-7894-4c3f-95a5-8710283848e4"."Description".value = "Window settings for vpetsettings";
      "kwinrulesrc"."eac1aa75-7894-4c3f-95a5-8710283848e4"."clientmachine".value = "localhost";
      "kwinrulesrc"."eac1aa75-7894-4c3f-95a5-8710283848e4"."desktops".value = "\0";
      "kwinrulesrc"."eac1aa75-7894-4c3f-95a5-8710283848e4"."desktopsrule".value = 3;
      "kwinrulesrc"."eac1aa75-7894-4c3f-95a5-8710283848e4"."position".value = "1116,529";
      "kwinrulesrc"."eac1aa75-7894-4c3f-95a5-8710283848e4"."positionrule".value = 4;
      "kwinrulesrc"."eac1aa75-7894-4c3f-95a5-8710283848e4"."title".value = "DVPet";
      "kwinrulesrc"."eac1aa75-7894-4c3f-95a5-8710283848e4"."titlematch".value = 1;
      "kwinrulesrc"."eac1aa75-7894-4c3f-95a5-8710283848e4"."types".value = 1;
      "kwinrulesrc"."eac1aa75-7894-4c3f-95a5-8710283848e4"."wmclass".value = "vpetsettings";
      "kwinrulesrc"."eac1aa75-7894-4c3f-95a5-8710283848e4"."wmclassmatch".value = 1;
      # Removed "plasma-localerc"."Formats" things 'cause udah ada lewat `i18n.extraLocaleSettings`
      "plasmarc"."Wallpapers"."usersWallpapers".value = "/home/d/Pictures/ROG-euy-1.jpg,/home/d/Pictures/10110.jpg,/home/d/Pictures/wow_coding_from_wallpapercave.webp,/home/d/Pictures/wallpapersden.com_binary-numbers-raining_6500x3520.jpg";
