...

{
  programs.plasma = {
    ...
    configFile = {
      ...
      "kglobalshortcutsrc"."org.gnome.Prompt.desktop"."_k_friendly_name" = "Prompt";
      ...
      "kwinrc"."SubSession: 09db50d0-706e-423f-a4bb-3edda1acddf4"."wmCommand2" = "firefox\s";
      ...
      "kwinrulesrc"."2"."title" = "Python Crash Course, 3rd Edition [EPUB] — E-book viewer";
      ...
      "kwinrulesrc"."4"."title" = "Python Crash Course, 3rd Edition [EPUB] — E-book viewer";
      ...
      "kwinrulesrc"."79255805-373c-4d48-8b56-e69686fff7fd"."title" = "Python Crash Course, 3rd Edition [EPUB] — E-book viewer";
